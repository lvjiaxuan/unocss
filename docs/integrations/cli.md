...
interface CliEntryItem {
  ...
  outFile: string
  /**
   * The output dir for the transformed files
   */
  outTransformed?: string
}
```
...
| `--out-transformed <dir>` | The output dir for the transformed files. Defaults to `uno-transformed` in the current working directory |
